...
<html lang="id">
        ...
        <link rel="icon" type="image/png" href="{{ asset('images/logo-kemenhut.png') }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-50 flex flex-col">
            ...
            <footer class="mt-10 border-t border-gray-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8 text-center text-xs text-gray-400">
                    &copy; {{ date('Y') }}
