<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->isKepalaBalai())
                <x-responsive-nav-link :href="route('kepala-balai.approval.index')" :active="request()->routeIs('kepala-balai.approval.*')">
                    {{ __('Approval Final') }}
                </x-responsive-nav-link>
            @endif
            ...
            @if (auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.leave-balances.index')" :active="request()->routeIs('admin.leave-balances.*')">
                    {{ __('Saldo Cuti') }}
                </x-responsive-nav-link>
