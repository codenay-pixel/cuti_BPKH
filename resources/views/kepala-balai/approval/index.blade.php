<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Persetujuan Final</h2>
        <p class="text-sm text-gray-500 mt-0.5">Keputusan Pejabat yang Berwenang Memberikan Cuti</p>
    </x-slot>
                    ...
                    @forelse ($pengajuan as $item)
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex gap-2">
                                <form method="POST" action="{{ route('kepala-balai.approval.approve', $item) }}" class="flex-1"
                            ...
                            <div x-show="tolakId === {{ $item->id }}" x-cloak style="display:none">
                                <form method="POST" action="{{ route('kepala-balai.approval.reject', $item) }}" class="space-y-2">
                                    @csrf
